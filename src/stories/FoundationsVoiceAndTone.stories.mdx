...
import ImgChoice1Bad from './assets/img-choice-1-bad.png';
import ImgChoice1Good from './assets/img-choice-1-good.png';
import ImgChoice2Bad from './assets/img-choice-2-bad.png';
import ImgChoice2Good from './assets/img-choice-2-good.png';

import BadTick from './assets/cross-bad.png';
import GoodTick from './assets/tick-good.png';
...
<div className="page-wrapper">
  ...
  <main>
    ...
    <div className="imageCmp">
      <img src={Tone1Bad} className="cmpImgText"/>
      <img src={Tone1Good} className="cmpImgText"/>
    </div>

    <div className="imageCmp">
      <img src={Tone2Bad} className="cmpImgText"/>
      <img src={Tone2Good} className="cmpImgText"/>
    </div>
    ...
    <div className="imageCmp">
      <img src={Tone3Bad} className="cmpImgText"/>
      <img src={Tone3Good} className="cmpImgText"/>
    </div>
    ...
    <div className="imageCmp">
      <img src={Tone4Bad} className="cmpImgText"/>
      <img src={Tone4Good} className="cmpImgText"/>
    </div>

    <h4>How to choose images</h4>

    <p>Use good quality images</p>

    <div className="imageCmp">
      <div className="imgContainer">
        <img src={ImgChoice1Good} className="exampleImg"/>
        <img src={GoodTick} className="tick"/>
      </div>

      <div className="imgContainer">
        <img src={ImgChoice1Bad} className="exampleImg"/>
        <img src={BadTick} className="tick"/>
      </div>
    </div>

    <p>Use minimal images that give a sense and space with a positive messege</p>

    <div className="imageCmp2">
      <div className="imgContainer">
        <img src={ImgChoice2Good} className="exampleImg2"/>
        <img src={GoodTick} className="tick"/>
      </div>

      <div className="imgContainer">
        <img src={ImgChoice2Bad} className="exampleImg2"/>
        <img src={BadTick} className="tick"/>
      </div>
    </div>
